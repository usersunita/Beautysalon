...
const ProductGrid = () => {
  return (
    <div className='w-full md:max-w-[90%] md:mx-auto'>
            <h3 className="text-4xl font-extrabold text-gray-800 text-center justify-center flex flex-col gap-6">Hot Deals</h3>
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-screen-xl mx-auto my-6 px-4">
