...
const Gallery = () => {
  return (
    <div>
      <div className="w-full md:max-w-[90%] md:mx-auto flex-col  py-10 justify-center items-center gap-10 ">
      ...
      <div className="w-full flex flex-col justify-center items-center py-10">
        <div className=" w-full grid md:grid-cols-4 grid-cols-1 justify-center items-center gap-4">
          <img   src={image3} alt="Gallery Image 1"  className="rounded-xl w-[300px] h-[350px] object-cover" />
